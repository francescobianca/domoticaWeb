		...
		try {
			...
			try {
				...
				while (resultSet.next()) {
					...
					//System.out.println("trigger:"+ Integer.toString(resultSet.getInt("id"))+"inizio-->"+"0 " + minuti + " " + ora + " * * ?");
					
					Trigger trigger = TriggerBuilder.newTrigger()
							.withIdentity("trigger:" + Integer.toString(resultSet.getInt("id"))+"inizio", "group1")
