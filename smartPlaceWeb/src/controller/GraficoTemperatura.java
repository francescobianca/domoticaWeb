...
public class GraficoTemperatura extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("Sono nella servlet grafico temperatura web ");
		...
		try {
			...
			ResultSet r = findTemperature(dataInizio, dataFine);
			...
			if (trovaDati)
				...
				System.out.println("datiNonPresenti");
		} catch (Exception e) {
	...
	private ResultSet findTemperature(String dataInizio, String dataFine) {
		...
		try {
			...
			statement.setString(4, "temperatura");
