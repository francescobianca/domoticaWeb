			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 mb-5 mb-lg-0">
						...
						<p class="lead mb-0">Università della Calabria, Via Pietro
					...
					<div class="col-md-4">
						...
						<p class="lead mb-0">
							Sviluppato da Bianca Francesco e Zarola Andrea per il corso di
							SIW</a>.
						</p>
					</div>
				</div>
	...
	<div class="portfolio-modal mfp-hide" id="categoria_cancello">
		<div class="portfolio-modal-dialog bg-white">
			...
			<div class="container text-center">
				<div class="row">
					<div class="col-lg-8 mx-auto">
						<h2 class="text-secondary text-uppercase mb-0">Cancello</h2>
						<hr class="star-dark mb-5">
	...
	<div class="portfolio-modal mfp-hide" id="categoria_sicurezza">
		<div class="portfolio-modal-dialog bg-white">
			...
			<div class="container text-center">
				<div class="row">
					<div class="col-lg-8 mx-auto">
						<h2 class="text-secondary text-uppercase mb-0">Sicurezza</h2>
						<hr class="star-dark mb-5">
