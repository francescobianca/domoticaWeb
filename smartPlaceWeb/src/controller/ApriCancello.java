...
public class ApriCancello extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("Sono nella servlet apri cancello web ");
		...
		try {
			...
			String stato = req.getParameter("operation");
			...
			resp.getOutputStream().print("cancelloSettato" + "-");
			resp.getOutputStream().print(newValue);
	...
	private int salvaStato(String indirizzoIP, String stanza, String stato) {
		...
		try {
			...
			statement.setString(4, "cancello");
